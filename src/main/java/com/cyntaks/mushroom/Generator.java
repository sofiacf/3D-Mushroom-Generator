...
public class Generator {
	...
	private final float screenWidth = 1024;
	private final float screenHeight = 768;
	...
	private final int lightRotationPauseLength = 1000*25;
	...
	private final int floorPoints = 800;

	public static float lightTimer;
	private final float lightCycleTime = 5000;
	...
	private void handleInput() {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_P)) {
			if (!this.pPressed) {
				...
				mainMush.transitioning = mainMush.continuallyTransition;
			}
		} else
			this.pPressed = false;

		//do thing
		this.mPressed = Keyboard.isKeyDown(Keyboard.KEY_M) && !this.mPressed;
